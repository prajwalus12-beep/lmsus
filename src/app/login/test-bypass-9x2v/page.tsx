...
export default function TestingLoginPage() {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(data.message || "Password reset link has been sent to your registered email!")
            ...
            <form onSubmit={handleResetPassword} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 justify-end pt-2">
                <button
                  ...
                  className="px-4 h-11 border border-slate-200 rounded-lg text-slate-700 font-semibold hover:bg-slate-50 transition-colors"
                >
                  Cancel
                </button>
                <Button
                  type="submit"
                  disabled={resetLoading}
                  className="h-11 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold"
                >
